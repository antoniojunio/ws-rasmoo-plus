...
public class ResourceHandle {
    ...
    public ResponseEntity<ErrorResponseDto> notFounException(NotFoundException n) {
    ...
    public ResponseEntity<ErrorResponseDto> notFounException(BadRequestException b) {
    ...
    public ResponseEntity<ErrorResponseDto> notFounException(DataIntegrityViolationException d) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ErrorResponseDto.builder()
